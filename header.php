...
<!--					<a href="../notification/notification.php"><span id="notiItemCount"></span><i class="fa fa-envelope fa-2x"></i> </a> <span>&nbsp;</span>-->
					<a href="../userProfile/userProfile.php"><i class="fa fa-profile fa-1x"></i><span style="font-size:20px;"><?php echo $_userName;?></span></a> <span>&nbsp;</span>
					<a href="../login/logout.php"><i class="fa fa-sign-out fa-1x"></i> Logout </a> <span>&nbsp;</span>
				<?php 	}else{ ?>					
					<a href="../login/loginForm.php"><i class="fa fa-sign-in fa-1x"> Login </i></a> <span>&nbsp;</span>
