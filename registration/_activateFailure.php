...
<html>
	...
	<body>
		<form name="regForm" method="post" action="./common/register.php" onsubmit="return formSubmit()">
			<div id="loading"></div>
					...
					<div id="right-panel" class="right-panel">
						...
						<div>
							<div>
								...
								<div class="container">
									<h5 class="reg_failure">Problem in user account activation. Please contact us by email or telephone for the problem!</h5>
									<hr>
